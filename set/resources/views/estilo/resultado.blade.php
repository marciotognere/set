...
@section('head')
  {{-- <script src="{{ asset('js/estilo.js') }}" defer></script>
...
@section('content')
  ...
  <h1 class="h3 mb-3 font-weight-normal text-center">Resultado do Estilo de Aprendizagem</h1>
  ...
  @php
    ...
    foreach ($agruparPorAno as $resul){
      //print("<pre>".print_r($resul,true)."</pre>");
      ...
      //         <b>Ativo</b>:'.(int)$ativo."%".'</br>
      //         <b>Reflexivo</b>:'.(int)$reflexivo."%".'</br>
      //         <b>Teórico</b>:'.(int)$teorico."%".'</br>
      //         <b>Pragmático</b>:'.(int)$pragmatico."%".'</br>
      //       </div>';
    }
  @endphp
    ...
    <div class="d-flex justify-content-center">
      <a type="submit" class="btn btn-primary" href="{{ url('/matricula') }}">Ok</a>
    </div>

    </br>
  </br>
  <div class="alert alert-danger" role="alert">
    Seu estilo de aprendizagem se evidência no gráfico acima. Abaixo segue algumas estratégias que o monitor pode aplicar para facilitar seu aprendizado.
  </div>
